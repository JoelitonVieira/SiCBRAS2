        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('cep_latitude', $cliente->cep_latitude , ['id' => 'cep-latitude']) !!}
                    {!! Form::hidden('cep_longitude', $cliente->cep_longitude , ['id' => 'cep-longitude']) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="contato">
                    @forelse(old('contatos', []) as $index => $data)
                        @include('admin.clientes.contatos_row', [
                            'index' => $index
                        ])
                    @empty
                        @foreach($cliente->contatos as $item)
                            @include('admin.clientes.contatos_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
