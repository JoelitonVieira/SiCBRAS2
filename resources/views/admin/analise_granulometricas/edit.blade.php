...
@section('content')
    ...
    {!! Form::model($analise_granulometrica, ['method' => 'PUT', 'route' => ['admin.analise_granulometricas.update', $analise_granulometrica->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('destino_latitude', $analise_granulometrica->destino_latitude , ['id' => 'destino-latitude']) !!}
                    {!! Form::hidden('destino_longitude', $analise_granulometrica->destino_longitude , ['id' => 'destino-longitude']) !!}
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="resultados-fisico">
                    @forelse(old('resultados_fisicos', []) as $index => $data)
                        @include('admin.analise_granulometricas.resultados_fisicos_row', [
                            'index' => $index
                        ])
                    @empty
                        @foreach($analise_granulometrica->resultados_fisicos as $item)
                            @include('admin.analise_granulometricas.resultados_fisicos_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
