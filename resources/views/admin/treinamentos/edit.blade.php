...
@section('content')
    ...
    {!! Form::model($treinamento, ['method' => 'PUT', 'route' => ['admin.treinamentos.update', $treinamento->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('nome_participantes[]', $nome_participantes, old('nome_participantes') ? old('nome_participantes') : $treinamento->nome_participantes->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-nome_participantes' , 'required' => '']) !!}
                    <p class="help-block"></p>
