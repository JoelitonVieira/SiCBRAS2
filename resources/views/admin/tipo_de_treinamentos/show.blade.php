                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td field-key='nome_tipo_treinamento'>{{ $tipo_de_treinamento->nome_tipo_treinamento }}</td>
                        </tr>
                    </table>
                </div>
            </div><!-- Nav tabs -->
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.tipo_de_treinamentos.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop
