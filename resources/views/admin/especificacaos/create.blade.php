...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.especificacaos.store']]) !!}
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="composicao-fisica">
                    @foreach(old('composicao_fisicas', []) as $index => $data)
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="composicao-granulometrica">
                    @foreach(old('composicao_granulometricas', []) as $index => $data)
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="composicao-quimica">
                    @foreach(old('composicao_quimicas', []) as $index => $data)
