...
<li role="presentation" class=""><a href="#treinamento" aria-controls="treinamento" role="tab" data-toggle="tab">Turmas</a></li>
</ul>
...
<div role="tabpanel" class="tab-pane " id="treinamento">
<table class="table table-bordered table-striped {{ count($treinamentos) > 0 ? 'datatable' : '' }}">
    <thead>
        <tr>
            <th>@lang('quickadmin.treinamento.fields.nome-treinamento')</th>
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.funcionarios.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop
