...
@section('content')
    ...
    {!! Form::model($areia_saida, ['method' => 'PUT', 'route' => ['admin.areia_saidas.update', $areia_saida->id]]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('data', trans('quickadmin.areia-saida.fields.data').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('lider', trans('quickadmin.areia-saida.fields.lider').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('forno', trans('quickadmin.areia-saida.fields.forno').'*', ['class' => 'control-label']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('forno'))
                        <p class="help-block">
                            {{ $errors->first('forno') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('saida', trans('quickadmin.areia-saida.fields.saida').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('saida_acumulada', trans('quickadmin.areia-saida.fields.saida-acumulada').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('observacao', trans('quickadmin.areia-saida.fields.observacao').'*', ['class' => 'control-label']) !!}
