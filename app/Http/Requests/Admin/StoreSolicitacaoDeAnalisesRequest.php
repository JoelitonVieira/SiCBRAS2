...
class StoreSolicitacaoDeAnalisesRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'mat_primas' => 'required|unique:solicitacao_de_analises,mat_primas',
            'lote_ano' => 'required|unique:solicitacao_de_analises,lote_ano,'.$this->route('solicitacao_de_analise'),
            'tipos_graf' => 'required|unique:solicitacao_de_analises,tipos_graf',
