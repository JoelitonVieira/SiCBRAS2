...
class Add5c19541cdf9e0RelationshipsToTreinamentoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('treinamentos', function(Blueprint $table) {
            if(Schema::hasColumn('treinamentos', 'nome_treinamento_id')) {
                $table->dropForeign('241552_5c157722df06c');
                $table->dropIndex('241552_5c157722df06c');
                $table->dropColumn('nome_treinamento_id');
            }
            if(Schema::hasColumn('treinamentos', 'nome_setores_id')) {
                $table->dropForeign('241552_5c1577230d62c');
                $table->dropIndex('241552_5c1577230d62c');
                $table->dropColumn('nome_setores_id');
            }
            if(Schema::hasColumn('treinamentos', 'instrutor_id')) {
                $table->dropForeign('241552_5c1577232984f');
                $table->dropIndex('241552_5c1577232984f');
                $table->dropColumn('instrutor_id');
            }
            if(Schema::hasColumn('treinamentos', 'tipo_treinamento_id')) {
                $table->dropForeign('241552_5c1577234413f');
                $table->dropIndex('241552_5c1577234413f');
                $table->dropColumn('tipo_treinamento_id');
            }
            if(Schema::hasColumn('treinamentos', 'espec_treinamento_id')) {
                $table->dropForeign('241552_5c1577236061f');
                $table->dropIndex('241552_5c1577236061f');
                $table->dropColumn('espec_treinamento_id');
            }
