...
class Add5c19541f20b6dRelationshipsToEspecificacaoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('especificacaos', function(Blueprint $table) {
            if(Schema::hasColumn('especificacaos', 'nome_cliente_id')) {
                $table->dropForeign('241825_5c16f12f0b9a6');
                $table->dropIndex('241825_5c16f12f0b9a6');
                $table->dropColumn('nome_cliente_id');
            }
            if(Schema::hasColumn('especificacaos', 'cd_produto_id')) {
                $table->dropForeign('241825_5c16f12f1e48f');
                $table->dropIndex('241825_5c16f12f1e48f');
                $table->dropColumn('cd_produto_id');
            }
